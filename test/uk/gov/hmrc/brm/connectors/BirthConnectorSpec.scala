    ...
    "authentication" should {
      ...
      "BirthErrorResponse 5xx when all attempts fail for authentication (SocketTimeoutException)" in {
        ...
        "BirthSuccessResponse when gro responds with 200" in {
          ...
          GroReferenceMetrics.metrics.defaultRegistry.counter(s"${GroReferenceMetrics.prefix}-200-success-response").getCount shouldBe 1
      ...
      "get" should {
        ...
        "getDetails" should {
          ...
          "BirthSuccessResponse when gro details responds with 200 with single record." in {
            ...
            GRODetailsMetrics.metrics.defaultRegistry.counter(s"${GRODetailsMetrics.prefix}-200-success-response").getCount shouldBe 1

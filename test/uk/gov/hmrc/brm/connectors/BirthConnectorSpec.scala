  ...
  "BirthConnector" when {
    ...
    "initialising" should {
      ...
      "having correct configurations" in {
        ...
        MockBirthConnectorTestConfig.delayTime shouldBe 5000
        MockBirthConnectorTestConfig.authenticator shouldBe a[Authenticator]
        MockBirthConnectorTestConfig.metrics shouldBe a[Metrics]
        MockBirthConnectorTestConfig.http shouldBe a[HttpClient]
      }
    }

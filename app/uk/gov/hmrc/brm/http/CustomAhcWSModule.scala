...
/**
  ...
  * This is the default AhcWSModule from the play.api.libs.ws.ahc library; the only change is
  *   the usage of the CustomWSConfigParser, rather than the default one, for the sake of
